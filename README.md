# Angular Boot Camp example: legacy-ng-model-two-way-binding
...
**[StackBlitz for legacy-ng-model-two-way-binding](https://stackblitz.io/github/AngularBootCamp/legacy-ng-model-two-way-binding)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-ng-model-two-way-binding.git
cd legacy-ng-model-two-way-binding
npm install
npm start
```
