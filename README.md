# Angular Boot Camp example: modules
...
**[StackBlitz for modules](https://stackblitz.io/github/AngularBootCamp/modules)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/modules.git
cd modules
npm install
npm start
```
