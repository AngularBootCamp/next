# Angular Boot Camp example: legacy-template-forms
...
**[StackBlitz for legacy-template-forms](https://stackblitz.io/github/AngularBootCamp/legacy-template-forms)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-template-forms.git
cd legacy-template-forms
npm install
npm start
```
