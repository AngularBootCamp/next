# Angular Boot Camp example: example-content-projection-use-case
...
**[StackBlitz for example-content-projection-use-case](https://stackblitz.io/github/AngularBootCamp/example-content-projection-use-case)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/example-content-projection-use-case.git
cd example-content-projection-use-case
npm install
npm start
```
