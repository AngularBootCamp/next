# Angular Boot Camp example: component-inheritance
...
**[StackBlitz for component-inheritance](https://stackblitz.io/github/AngularBootCamp/component-inheritance)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/component-inheritance.git
cd component-inheritance
npm install
npm start
```
