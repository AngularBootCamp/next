# Angular Boot Camp example: example-nested-api-via-observables
...
**[StackBlitz for example-nested-api-via-observables](https://stackblitz.io/github/AngularBootCamp/example-nested-api-via-observables)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/example-nested-api-via-observables.git
cd example-nested-api-via-observables
npm install
npm start
```
