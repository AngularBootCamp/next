# Angular Boot Camp example: input-data-bindings
...
**[StackBlitz for input-data-bindings](https://stackblitz.io/github/AngularBootCamp/input-data-bindings)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/input-data-bindings.git
cd input-data-bindings
npm install
npm start
```
