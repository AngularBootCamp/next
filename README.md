# Angular Boot Camp example: auxiliary-routes
...
**[StackBlitz for auxiliary-routes](https://stackblitz.io/github/AngularBootCamp/auxiliary-routes)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/auxiliary-routes.git
cd auxiliary-routes
npm install
npm start
```
