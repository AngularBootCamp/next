# Angular Boot Camp example: component-lifecycle
...
**[StackBlitz for component-lifecycle](https://stackblitz.io/github/AngularBootCamp/component-lifecycle)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/component-lifecycle.git
cd component-lifecycle
npm install
npm start
```
