# Angular Boot Camp example: legacy-promises
...
**[StackBlitz for legacy-promises](https://stackblitz.io/github/AngularBootCamp/legacy-promises)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-promises.git
cd legacy-promises
npm install
npm start
```
