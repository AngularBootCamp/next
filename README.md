# Angular Boot Camp example: multiproviders
...
**[StackBlitz for multiproviders](https://stackblitz.io/github/AngularBootCamp/multiproviders)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/multiproviders.git
cd multiproviders
npm install
npm start
```
