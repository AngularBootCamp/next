# Angular Boot Camp example: custom-pipes
...
**[StackBlitz for custom-pipes](https://stackblitz.io/github/AngularBootCamp/custom-pipes)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/custom-pipes.git
cd custom-pipes
npm install
npm start
```
