# Angular Boot Camp example: legacy-more-ng-model
...
**[StackBlitz for legacy-more-ng-model](https://stackblitz.io/github/AngularBootCamp/legacy-more-ng-model)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-more-ng-model.git
cd legacy-more-ng-model
npm install
npm start
```
