# Angular Boot Camp example: legacy-ngrx-effects
...
**[StackBlitz for legacy-ngrx-effects](https://stackblitz.io/github/AngularBootCamp/legacy-ngrx-effects)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-ngrx-effects.git
cd legacy-ngrx-effects
npm install
npm start
```
