# Angular Boot Camp example: dependency-injection-and-http
...
**[StackBlitz for dependency-injection-and-http](https://stackblitz.io/github/AngularBootCamp/dependency-injection-and-http)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/dependency-injection-and-http.git
cd dependency-injection-and-http
npm install
npm start
```
