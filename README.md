# Angular Boot Camp example: example-non-singleton-service
...
**[StackBlitz for example-non-singleton-service](https://stackblitz.io/github/AngularBootCamp/example-non-singleton-service)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/example-non-singleton-service.git
cd example-non-singleton-service
npm install
npm start
```
