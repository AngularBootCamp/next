# Angular Boot Camp example: component-css
...
**[StackBlitz for component-css](https://stackblitz.io/github/AngularBootCamp/component-css)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/component-css.git
cd component-css
npm install
npm start
```
