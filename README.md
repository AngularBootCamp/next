# Angular Boot Camp example: library-firebase-weather
...
**[StackBlitz for library-firebase-weather](https://stackblitz.io/github/AngularBootCamp/library-firebase-weather)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/library-firebase-weather.git
cd library-firebase-weather
npm install
npm start
```
