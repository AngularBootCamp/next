# Angular Boot Camp example: legacy-api-via-http-promises
...
**[StackBlitz for legacy-api-via-http-promises](https://stackblitz.io/github/AngularBootCamp/legacy-api-via-http-promises)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-api-via-http-promises.git
cd legacy-api-via-http-promises
npm install
npm start
```
