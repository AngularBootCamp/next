# Angular Boot Camp example: library-firebase-data-flow
...
**[StackBlitz for library-firebase-data-flow](https://stackblitz.io/github/AngularBootCamp/library-firebase-data-flow)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/library-firebase-data-flow.git
cd library-firebase-data-flow
npm install
npm start
```
